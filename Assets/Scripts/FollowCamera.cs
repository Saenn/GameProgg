...
public class FollowCamera : MonoBehaviour {
	...
	Camera playerCam;
	public CubeMove getActions; //Here We Get Actions From the PlayerMove Script
	public float cameraDistance=10.0f; // Camera Distance for Third Person View.
	...
	void Start () {
		getActions = FindObjectOfType<CubeMove> ();
